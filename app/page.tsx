    ...
    <div className="flex h-dvh max-h-dvh flex-col overflow-hidden bg-white px-6 font-sans antialiased">
      ...
      <div className="w-full max-w-sm shrink-0 self-center pb-[max(1rem,env(safe-area-inset-bottom))] pt-3">
        <button
          ...
          className={`flex w-full items-center justify-center gap-2.5 rounded-2xl border border-gray-200 bg-white py-3.5 text-base font-semibold text-gray-800 shadow-sm transition-all hover:border-purple-300 hover:bg-gray-50 active:scale-95 sm:gap-3 sm:py-4 sm:text-lg ${isLoggingIn ? 'opacity-50 cursor-not-allowed' : ''}`}
        >
          {isLoggingIn ? (
